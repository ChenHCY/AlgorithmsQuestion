        ...
        for(int i = 0; i < board.length; i++){
            ...
            for(int j = 0; j < board[0].length; j++){
                ...
                /*       i: 0 1 2 | 3 4 5 | 6 7 8       j: 0 1 2 | 3 4 5 | 6 7 8
                  ...
                  Check from the first 3*3 square on the top left： left -> right, top -> down
                  i = 0 j = 0 - 8: ==> row: 0 1(j=3) 2(j=6)  column = colIndex(0) + 0 || 1 || 2 (0,0) (0,1) (0,2) (1, 0) (1, 1) (1, 2)... (2, 2)
                  i = 1 j = 0 - 8: ==> row: 0 1(j=3) 2(j=6)  column = colIndex(3) + 0 || 1 || 2 (0,3) (0,4) (0,5) (1, 3) (1, 4) (1, 5)... (2, 5)
                  i = 2 j = 0 - 8: ==> row: 0 1(j=3) 2(j=6)  column = colIndex(6) + 0 || 1 || 2 (0,6) (0,7) (0,8) (1, 6) (1, 7) (1, 8)... (2, 8)
                  
                  i = 3 j = 0 - 8: ==> row: 3 4(j=3) 5(j=6)  column = colIndex(0) + 0 || 1 || 2 (3,0) (3,1) (3,2) (4, 0) (4, 1) (4, 2)... (5, 2)
                  i = 4 j = 0 - 8: ==> row: 3 4(j=3) 5(j=6)  column = colIndex(3) + 0 || 1 || 2 (3,3) (3,4) (3,5) (4, 3) (4, 4) (4, 5)... (5, 5)
                  i = 5 j = 0 - 8: ==> row: 3 4(j=3) 5(j=6)  column = colIndex(6) + 0 || 1 || 2 (3,6) (3,7) (3,8) (4, 6) (4, 7) (4, 8)... (5, 8)
                  
                  i = 6 j = 0 - 8: ==> row: 6 7(j=3) 8(j=6)  column = colIndex(0) + 0 || 1 || 2 (6,0) (6,1) (6,2) (7, 0) (7, 1) (7, 2)... (8, 2)
                  i = 7 j = 0 - 8: ==> row: 6 7(j=3) 8(j=6)  column = colIndex(3) + 0 || 1 || 2 (6,3) (6,4) (6,5) (7, 3) (7, 4) (7, 5)... (8, 5)
                  i = 8 j = 0 - 8: ==> row: 6 7(j=3) 8(j=6)  column = colIndex(6) + 0 || 1 || 2 (6,6) (6,7) (6,8) (7, 6) (7, 7) (7, 8)... (8, 8)
                */
