...
2. String[] insert(int idKey, String value) Inserts the pair (idKey, value) 
...
// Solution 1: Used HashMap to solve it
class OrderedStream {
    ...
    public List<String> insert(int idKey, String value) {
        ...
        while(map.containsKey(lastIndex + 1)){
            list.add(map.get(++lastIndex));
        }
        return list;
    }
}
...
//Solution 2: Used String Array[] to solve it
class OrderedStream {
    ...
    public List<String> insert(int idKey, String value) {
        array[idKey - 1] = value; //add and save the value into String array[]
        List<String> list = new ArrayList<>();
    
        while(lastIndex < array.length && array[lastIndex] != null){
