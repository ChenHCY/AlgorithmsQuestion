/* Leetcode (Contest 344) 2670 Find the Distinct Difference Array

You are given a 0-indexed array nums of length n.

The distinct difference array of nums is an array diff of length n such that diff[i] is equal to the number of 
distinct elements in the suffix nums[i + 1, ..., n - 1] subtracted from the number of distinct elements in the prefix nums[0, ..., i].
...
class Solution {
    public int[] distinctDifferenceArray(int[] nums) {
        ...
        for(int i = 0; i < n; i++){
            ...
            res[i] = prefix.size() - distinct.size();
        }
